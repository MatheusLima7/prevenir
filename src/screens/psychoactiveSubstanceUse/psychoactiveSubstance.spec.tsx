...
import PsychoactiveSubstanceUse from "./psychoactiveSubstanceUse";
...
describe("Psycho Active Substance Screen Component", () => {
  it("should render component correctly", () => {
    const container = render(<PsychoactiveSubstanceUse />);
